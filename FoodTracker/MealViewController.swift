...
UINavigationControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        // basically use this viewcontroller for delegating anythgin which happens to the text field
    ...
    // this get's called when a user press Done or Enter after typing
